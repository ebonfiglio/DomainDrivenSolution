...
namespace DomainDrivenSolution.Tests
{
    public class MoneySpecs
    {
        ...
        public void Cannot_create_money_wth_negative_value(int oneCentCount, int tenCentCount, int quarterCount, int oneDollarCount, int fiveDollarCount, int twentyDollarCount)
        {
